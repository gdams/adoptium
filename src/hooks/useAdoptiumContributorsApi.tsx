...
const repositories = [
  'temurin-build', 'ci-jenkins-pipelines', 'infrastructure', 'aqa-tests', 'website-v2', 'api.adoptium.net', 'adoptium.net/blog', 'containers', 'installer',
...
const CONTRIBUTORS_API_URI =
  `https://api.github.com/repos/adoptium/${repoToCheck}/contributors?per_page=1`;
