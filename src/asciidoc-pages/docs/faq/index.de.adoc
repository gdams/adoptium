...
:page-authors: gdams, HanSolo, sw-fox
...
https://adoptium.net/slack.html[Slack-Channel] oder über einen Issue im
https://github.com/adoptium/adoptium-support[Support-Kanal].


== Wo sind die neuesten JDKs?

Die meisten der Eclipse Temurin builds mit HotSpot für 8u322-b09, 11.0.15+10
und jdk-17.0.3+7 sind nun auf dieser Seite verfügbar.
...
Längere Antwort: Die Builds, welche Sie als AdoptOpenJDK kennen, sind jetzt "Eclipse Temurin by Adoptium"(https://blog.adoptium.net/2021/08/adoptium-celebrates-first-release/[release blog post])
...
Jene Benutzer, welche sich eine containerbasierte Linux-Distribution wünschen, für die wir kein Image zur Verfügung stellen, verweisen wir an https://blog.adoptium.net/2021/08/using-jlink-in-dockerfiles/[diese
Anleitung].
