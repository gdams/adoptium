...
Si quieres conversar con nosotros sobre estos topicos, o realizar preguntas adicionales 
el mejor lugar es vía 
https://adoptium.net/slack.html[Slack] o levantando un issue en 
...
uso están disponibles en nuestro https://adoptium.net/temurin/releases/[ultima pagina de versiones].
...
https://hub.docker.com/_/eclipse-temurin[Imagenes docker oficiales], y ud puede usar Temurin mediante el Github
