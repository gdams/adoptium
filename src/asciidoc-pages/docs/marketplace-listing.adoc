...
== Repository Read and Marketpalce Update Process
...
The marketplace information replaces any previous information held for this vendor.

//TODO: link to the product listing info anchor in the guide
...
. Release file information is parsed according to the schema and product information is replaced in the marketplace for this vendor.
