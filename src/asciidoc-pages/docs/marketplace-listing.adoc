...
The signature must be a Base64-encoded, RSA encrypted, SHA-256 hash of your entire file content. The signature will be verified using the public key provided in your xref:marketplace-guide.adoc#Providing-Publisher-Information[publisher information].
...
The marketplace information replaces any previous information held for xref:marketplace-guide#Providing-Publisher-Information[this vendor].
